...
<div class="wrapper">
<header>
  <h3 class="title">User Registration Form</h3>
    </header>
<section class="form">

<form  action="<?php echo base_url().'index.php/User/create';?>" class="form" method="post">
  <div class="form-group">
    <label for="exampleInputEmail1">Enter Name</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Full Name" name="name" value="<?php echo set_value('name'); ?>" style="text-transform: capitalize;">
    <small id="nameHelp" class="form-text text-danger"><?php echo form_error('name')?></small>
  
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">Email address</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="john@example.com" name="email" value="<?php echo set_value('email'); ?>">
    <small id="emailHelp" class="form-text text-danger"><?php echo form_error('email')?></small>

  </div>
  <div class="form-group">
    <label for="exampleInputPhone">Phone Number</label>
    <input type="tel" class="form-control" id="exampleInputPhone" aria-describedby="phoneHelp" placeholder="+977" name="phone" pattern="[0-9]{10}" value="<?php echo set_value('phone'); ?>">
